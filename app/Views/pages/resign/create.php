...
<div class="min-height-200px">
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <div class="dropdown">
                    <a class="btn btn-warning" href="<?= base_url('/resign') ?>" role="button">
    ...
    <div class="pd-20 card-box mb-30">
        ...
        <br>
        <form action="<?= site_url('/resign/store') ?>" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-8">
                    <input class="form-control" type="date" name="resign_date">
                </div>
