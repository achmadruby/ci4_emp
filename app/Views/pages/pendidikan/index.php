...
<div class="min-height-200px">
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <div class="dropdown">
                    <a class="btn btn-primary" href="<?= base_url('/pendidikan/create') ?>" role="button">
    ...
    <div class="card-box mb-30">
        <div class="pd-20">
            <h4 class="text-blue h4">Tabel Data Pendidikan</h4>
        </div>
        <div class="pb-20">
            <table class="table hover multiple-select-row data-table-export nowrap">
                ...
                <tbody>
                    <?php
                    $no = 1;
                    foreach ($pendidikan['pendidikan'] as $pendidikan):
                        ?>
                        <tr>
                            <th>
                                <?= $no++ ?>
                            ...
                            <td>
                                <a href="<?= site_url('/pendidikan/edit/' . $pendidikan['id']) ?>"
                                    class="btn btn-warning btn-sm"><i class="icon-copy dw dw-edit2"></i></a>
                                <a href="<?= site_url('/pendidikan/delete/' . $pendidikan['id']) ?>"
