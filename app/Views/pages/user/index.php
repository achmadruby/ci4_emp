...
<div class="min-height-200px">
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <div class="dropdown">
                    <a class="btn btn-primary" href="<?= base_url('/user/create') ?>" role="button">
    ...
    <div class="card-box mb-30">
        <div class="pd-20">
            <h4 class="text-blue h4">Tabel Data User</h4>
        </div>
        <div class="pb-20">
                ...
                <tbody>
                    ...
                    foreach ($user['user'] as $user):
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= site_url('/user/edit/' . $user['userid']) ?>" class="btn btn-warning btn-sm"><i
